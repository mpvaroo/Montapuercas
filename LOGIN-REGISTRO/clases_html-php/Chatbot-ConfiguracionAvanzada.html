...
<head>
  ...
  <style>
    ...
    .hours-grid{display:grid;grid-template-columns:160px 1fr 1fr;gap:.5rem}
    .hours-grid .day{font-weight:600}
    footer{text-align:center;padding:1rem;font-size:.9rem;color:#777;margin-top:3rem}
    @media (max-width: 991px){.hours-grid{grid-template-columns:1fr}}
  </style>
</head>
<body>
  ...
  <main class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h4>Ajustes del comportamiento del chatbot</h4>
      <div class="d-flex gap-2">
        <button class="btn btn-outline-secondary">Cancelar</button>
        <button class="btn btn-primary">Guardar cambios</button>
      </div>
    </div>
    <p class="text-muted mb-4">Configura idioma, tono, horario de atención, reglas de derivación a humano y límites operativos.</p>
    ...
    <div class="card section-card mb-4">
      <div class="card-body">
        ...
        <div class="form-check form-switch mb-3">
          ...
          <label class="form-check-label" for="switchHorario">Activar horario de atención (fuera de horario el bot responde con mensaje de espera)</label>
        </div>
      ...
      <div class="card-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="email" class="form-control" placeholder="soporte@tuempresa.com" value="soporte@tuempresa.com">
          </div>
          <div class="col-md-6">
