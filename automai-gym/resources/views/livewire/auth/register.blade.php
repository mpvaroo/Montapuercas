<x-layouts::auth>
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('register.store') }}" class="flex flex-col gap-6">
            ...
            <!-- Name -->
            <flux:input name="nombre_mostrado_usuario" :label="__('Name')" :value="old('nombre_mostrado_usuario')"
                type="text" required autofocus autocomplete="name" :placeholder="__('Full name')" />

            <!-- Email Address -->
            <flux:input name="correo_usuario" :label="__('Email address')" :value="" type="email"
